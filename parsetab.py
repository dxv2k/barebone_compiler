...
_lr_productions = [
  ...
  ('expr -> expr PLUS expr','expr',3,'p_add','simple_calc.py',49),
  ('expr -> expr MINUS expr','expr',3,'p_sub','simple_calc.py',53),
  ('expr -> MINUS expr','expr',2,'p_expr2uminus','simple_calc.py',57),
  ('expr -> expr TIMES expr','expr',3,'p_mult_div','simple_calc.py',61),
  ('expr -> expr DIV expr','expr',3,'p_mult_div','simple_calc.py',62),
  ('expr -> NUMBER','expr',1,'p_expr2NUM','simple_calc.py',73),
  ('expr -> LPAREN expr RPAREN','expr',3,'p_parens','simple_calc.py',77),
]
